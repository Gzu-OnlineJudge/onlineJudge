    ...
    <div class="w-100">
      <div class="mt-0 bg-white w-100 d-flex shadow-sm flex-column flex-md-row">
        <div class="container filter-menu">
          <ul class="pl-0 position-relative" id="filter">
            <h5>比赛状态 : </h5>
            <li id='slide'></li>
            <li @click="filter=1" :class="filter == 1 ? 'active':''">未开始</li>
            <li @click="filter=2" :class="filter == 2 ? 'active':''">进行中</li>
            <li @click="filter=3" :class="filter == 3 ? 'active':''">已结束</li>
            <li @click="filter=4" :class="filter == 4 ? 'active':''">全部</li>
          </ul>
        </div>
      </div>
                ...
                <div class="card-body position-relative">
                  ...
                  <div class="d-flex flex-md-row flex-column">
                    ...
                    <div class="mb-2 mr-3 d-flex align-items-center text-dark">
                      ...
                      发布 :<router-link to="#" class="ml-1">{{i.owner.username}}</router-link>
                    </div>
                    <div class="mb-2 mr-3 d-flex align-items-center text-dark">
                      <svg class="mr-2" viewBox="0 0 1024 1024" width="18" height="18">
...
<script>
  ...
  export default {
    ...
    beforeRouteEnter(to, from, next){
      axios.get('http://192.168.0.100:8000/api/contest/').then(res=>{
